...
saashq.query_reports["Work Order Summary"] = {
	filters: [
		{
			label: __("Company"),
			fieldname: "company",
		...
		},
		{
			...
			fieldname: "from_date",
			fieldtype: "Date",
			default: saashq.datetime.add_months(saashq.datetime.get_today(), -3),
			reqd: 1,
		},
		{
		...
		},
		{
			...
			get_data: function (txt) {
				return saashq.db.get_link_options("Sales Order", txt);
			},
		},
		{
