...
from saashq.utils import add_years, cint, flt, getdate
...
class ForecastingReport(ExponentialSmoothingForecast):
	def __init__(self, filters=None):
		...
		self.company_currency = erpnexus.get_company_currency(self.filters.company)
	...
	def get_data_for_forecast(self):
		parent = saashq.qb.DocType(self.doctype)
		child = saashq.qb.DocType(self.child_doctype)
