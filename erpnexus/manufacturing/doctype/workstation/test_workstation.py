...
from erpnexus.manufacturing.doctype.routing.test_routing import create_routing, setup_bom
from erpnexus.manufacturing.doctype.workstation.workstation import (
...
class TestWorkstation(IntegrationTestCase):
	...
	def test_update_bom_operation_rate(self):
		...
		w1 = saashq.get_doc("Workstation", "_Test Workstation A")
		# resets values
...
def make_workstation(*args, **kwargs):
	...
	if not saashq.db.exists("Workstation", workstation_name):
		doc = saashq.get_doc({"doctype": "Workstation", "workstation_name": workstation_name})
	...
	return saashq.get_doc("Workstation", workstation_name)
