...
def execute():
	if saashq.db.table_exists("Membership Settings"):
		saashq.rename_doc("DocType", "Membership Settings", "Non Profit Settings")
		saashq.reload_doctype("Non Profit Settings", force=True)

	if saashq.db.table_exists("Non Profit Settings"):
		rename_fields_map = {
