import saashq
from saashq.utils import get_time, getdate, today

from erpnexus.accounts.utils import update_gl_entries_after
from erpnexus.stock.stock_ledger import update_entries_after
...
def execute():
	...
	for module, doctype in doctypes_to_reload:
		saashq.reload_doc(module, "doctype", doctype)
	...
	saashq.clear_cache()
	saashq.flags.warehouse_account_map = {}
	...
	if data:
		for row in saashq.get_all("Company", filters={"enable_perpetual_inventory": 1}):
