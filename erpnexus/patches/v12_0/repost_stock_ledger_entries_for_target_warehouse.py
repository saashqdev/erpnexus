...
def execute():
	...
	for doctype in ["Sales Invoice", "Delivery Note"]:
		if not saashq.get_meta(doctype + " Item").get_field("target_warehouse").hidden:
			continue
	...
	if saashq.get_meta("Sales Order Item").get_field("target_warehouse").hidden:
		saashq.db.sql(
