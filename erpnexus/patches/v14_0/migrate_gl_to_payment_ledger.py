...
from saashq.query_builder import CustomFunction
from saashq.query_builder.custom import ConstantColumn
from saashq.query_builder.functions import Count, IfNull
...
def get_columns():
	...
	if saashq.db.has_column("Payment Ledger Entry", "remarks"):
...
def execute():
	...
	if saashq.reload_doc("accounts", "doctype", "payment_ledger_entry"):
