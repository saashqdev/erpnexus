...
def set_series(doctype, value):
	doc = saashq.db.exists("Property Setter", {"doc_type": doctype, "property": "autoname"})
	if doc:
		saashq.db.set_value("Property Setter", doc, "value", value)
	else:
...
def get_series_to_preserve(doctype):
	series_to_preserve = saashq.db.get_value("DocType", doctype, "autoname")
