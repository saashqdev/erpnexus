...
from erpnexus.accounts.doctype.pos_closing_entry.test_pos_closing_entry import init_user_and_profile
...
class TestPOSInvoiceMergeLog(IntegrationTestCase):
	...
	def test_consolidated_invoice_creation(self):
		...
		try:
			...
			self.assertTrue(saashq.db.exists("Sales Invoice", pos_inv.consolidated_invoice))

			pos_inv3.load_from_db()
			self.assertTrue(saashq.db.exists("Sales Invoice", pos_inv3.consolidated_invoice))
	...
	def test_consolidated_credit_note_creation(self):
		...
		try:
			...
			self.assertTrue(saashq.db.exists("Sales Invoice", pos_inv_cn.consolidated_invoice))
			consolidated_credit_note = saashq.get_doc("Sales Invoice", pos_inv_cn.consolidated_invoice)
	...
	def test_consolidated_invoice_item_taxes(self):
		...
		try:
			...
			consolidated_invoice = saashq.get_doc("Sales Invoice", inv.consolidated_invoice)
