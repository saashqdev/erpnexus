...
from saashq.utils import add_months, getdate
...
from erpnexus.tests.utils import if_lending_app_installed, if_lending_app_not_installed
...
class TestBankClearance(IntegrationTestCase):
	...
	def test_bank_clearance(self):
		bank_clearance = saashq.get_doc("Bank Clearance")
	...
	def test_update_clearance_date_on_si(self):
		...
		si_clearance_date = saashq.db.get_value(
...
def make_bank_account():
	if not saashq.db.get_value("Account", "_Test Bank Clearance - _TC"):
		saashq.get_doc(
			{
				"doctype": "Account",
				"account_type": "Bank",
