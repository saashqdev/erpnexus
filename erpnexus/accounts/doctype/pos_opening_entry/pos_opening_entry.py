...
class POSOpeningEntry(StatusUpdater):
	...
	if TYPE_CHECKING:
		...
		from erpnexus.accounts.doctype.pos_opening_entry_detail.pos_opening_entry_detail import (
	...
	def validate_pos_profile_and_cashier(self):
		...
		if not cint(saashq.db.get_value("User", self.user, "enabled")):
			saashq.throw(_("User {} is disabled. Please select valid user/cashier").format(self.user))
