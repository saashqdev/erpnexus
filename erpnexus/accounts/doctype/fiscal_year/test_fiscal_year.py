...
class TestFiscalYear(IntegrationTestCase):
	def test_extra_year(self):
		if saashq.db.exists("Fiscal Year", "_Test Fiscal Year 2000"):
			saashq.delete_doc("Fiscal Year", "_Test Fiscal Year 2000")
		...
		self.assertRaises(saashq.exceptions.InvalidDates, fy.insert)
