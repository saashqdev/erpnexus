...
from erpnexus.accounts.doctype.process_statement_of_accounts.process_statement_of_accounts import (
	get_statement_dict,
	send_emails,
)
...
def create_process_soa(**args):
	...
	saashq.delete_doc_if_exists("Process Statement Of Accounts", args.name)
	process_soa = saashq.new_doc("Process Statement Of Accounts")
	soa_dict = saashq._dict(
		name=args.name,
