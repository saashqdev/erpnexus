...
from saashq.utils import add_months, nowdate

from erpnexus.accounts.doctype.accounting_period.accounting_period import (
...
class TestAccountingPeriod(IntegrationTestCase):
	...
	def tearDown(self):
		for d in saashq.get_all("Accounting Period"):
			saashq.delete_doc("Accounting Period", d.name)


def create_accounting_period(**args):
	args = saashq._dict(args)

	accounting_period = saashq.new_doc("Accounting Period")
