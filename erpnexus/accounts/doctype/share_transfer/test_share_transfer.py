...
from erpnexus.accounts.doctype.share_transfer.share_transfer import ShareDontExists
...
class TestShareTransfer(IntegrationTestCase):
	def setUp(self):
		saashq.db.sql("delete from `tabShare Transfer`")
		saashq.db.sql("delete from `tabShare Balance`")
		share_transfers = [
			{
