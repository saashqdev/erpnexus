...
from erpnexus.accounts.doctype.tax_rule.tax_rule import ConflictingTaxRule, get_tax_template
...
class TestTaxRule(IntegrationTestCase):
	...
	def setUpClass(cls):
		super().setUpClass()
		saashq.db.set_single_value("Shopping Cart Settings", "enabled", 0)
...
def make_tax_rule(**args):
	...
	tax_rule = saashq.new_doc("Tax Rule")
