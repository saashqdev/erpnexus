...
from erpnexus.accounts.party import get_party_shipping_address
...
class TestUtils(IntegrationTestCase):
	...
	def test_update_reference_in_payment_entry(self):
		...
		payment_reconciliation = saashq.new_doc("Payment Reconciliation")
	...
	def test_naming_series_variable_parsing(self):
		...
		saashq.db.set_default("supp_master_name", "Auto Name")
		...
		saashq.db.set_default("supp_master_name", "Supplier Name")
