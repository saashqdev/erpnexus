...
def execute(filters=None):
	...
	account_currency = saashq.get_cached_value("Account", filters.account, "account_currency")
...
def get_entries(filters):
	...
	for method_name in saashq.get_hooks("get_entries_for_bank_reconciliation_statement"):
		entries += saashq.get_attr(method_name)(filters) or []
