...
from erpnexus.accounts.party import get_partywise_advanced_payment_amount
	...
	def get_data(self, args):
		...
		for party, party_dict in self.party_total.items():
			...
			if self.party_naming_by == "Naming Series":
				...
				row.party_name = saashq.get_cached_value(doctype, party, fieldname)
