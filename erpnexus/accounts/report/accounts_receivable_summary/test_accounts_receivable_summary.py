...
from erpnexus.accounts.report.accounts_receivable_summary.accounts_receivable_summary import execute
...
class TestAccountsReceivable(AccountsTestMixin, IntegrationTestCase):
	...
	def test_01_receivable_summary_output(self):
		...
		customer_group, customer_territory = saashq.db.get_all(
			"Customer",
