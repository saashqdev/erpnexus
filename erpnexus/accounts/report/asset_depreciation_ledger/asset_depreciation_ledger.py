...
def get_data(filters):
	data = []
	depreciation_accounts = saashq.db.sql_list(
	...
	company_fb = saashq.get_cached_value("Company", filters.get("company"), "default_finance_book")
	...
	for d in gl_entries:
		...
		if asset_data:
			if not asset_data.get("accumulated_depreciation_amount"):
				...
				query = (
					saashq.qb.from_(DepreciationSchedule)
...
def get_assets_details(assets):
	...
	for d in saashq.get_all("Asset", fields=fields, filters={"name": ("in", assets)}):
