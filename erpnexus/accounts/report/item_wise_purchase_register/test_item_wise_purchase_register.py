...
from erpnexus.accounts.report.item_wise_purchase_register.item_wise_purchase_register import execute
...
class TestItemWisePurchaseRegister(AccountsTestMixin, IntegrationTestCase):
	...
	def test_basic_report_output(self):
		...
		filters = saashq._dict({"from_date": today(), "to_date": today(), "company": self.company})
