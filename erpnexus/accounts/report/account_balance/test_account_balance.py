...
from erpnexus.accounts.report.account_balance.account_balance import execute


class TestAccountBalance(IntegrationTestCase):
	def test_account_balance(self):
		saashq.db.sql("delete from `tabSales Invoice` where company='_Test Company 2'")
		saashq.db.sql("delete from `tabGL Entry` where company='_Test Company 2'")
