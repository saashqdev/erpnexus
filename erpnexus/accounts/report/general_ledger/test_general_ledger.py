...
from erpnexus.accounts.report.general_ledger.general_ledger import execute
...
class TestGeneralLedger(IntegrationTestCase):
	...
	def test_foreign_account_balance_after_exchange_rate_revaluation(self):
		...
		revaluation = saashq.new_doc("Exchange Rate Revaluation")
	...
	def test_ignore_cr_dr_notes_filter(self):
		...
		system_generated_journal = saashq.db.get_all(
			"Journal Entry",
			filters={
				"docstatus": 1,
