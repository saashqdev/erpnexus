...
saashq.query_reports["Accounts Receivable"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
		...
		},
		{
			...
			get_data: function (txt) {
				return saashq.db.get_link_options("Customer Group", txt);
			},
		},
		{
	...
	onload: function (report) {
		report.page.add_inner_button(__("Accounts Receivable Summary"), function () {
			...
			saashq.set_route("query-report", "Accounts Receivable Summary", { company: filters.company });
		});
	},
};

erpnexus.utils.add_dimensions("Accounts Receivable", 9);
