...
from saashq.utils import date_diff, flt
...
def get_communication_details(filters):
	...
	communication_list = []
	opportunities = saashq.db.get_values(
		"Opportunity",
	...
	for d in opportunities:
		...
		communication_count = saashq.db.sql(
			"""
				SELECT
					count(*)
				FROM
		...
		support_tickets = len(saashq.db.get_all("Issue", {"raised_by": d.contact_email}))
