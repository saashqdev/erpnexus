...
class OpportunitySummaryBySalesStage:
	...
	def set_sales_stage_columns(self):
		self.sales_stage_list = saashq.db.get_list("Sales Stage", pluck="name")
	...
	def get_formatted_data(self):
		self.formatted_data = saashq._dict()
	...
	def set_formatted_data_based_on_sales_stage(self, based_on, sales_stage, count):
		self.formatted_data.setdefault(based_on, saashq._dict()).setdefault(sales_stage, 0)
