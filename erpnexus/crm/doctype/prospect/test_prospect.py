...
from erpnexus.crm.doctype.lead.lead import add_lead_to_prospect
...
class TestProspect(IntegrationTestCase):
	...
	def test_make_customer_from_prospect(self):
		...
		saashq.delete_doc_if_exists("Customer", "_Test Prospect")
