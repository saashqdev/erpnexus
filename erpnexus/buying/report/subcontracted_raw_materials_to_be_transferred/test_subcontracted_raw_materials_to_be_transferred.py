...
# Embedded file name: /Users/anuragmishra/saashq-develop/apps/erpnexus/erpnexus/buying/report/subcontracted_raw_materials_to_be_transferred/test_subcontracted_raw_materials_to_be_transferred.py
...
from erpnexus.buying.report.subcontracted_raw_materials_to_be_transferred.subcontracted_raw_materials_to_be_transferred import (
	execute,
)
			...
			filters=saashq._dict(
				{
					...
					"from_date": saashq.utils.get_datetime(
						saashq.utils.add_to_date(sco.transaction_date, days=-10)
					),
					"to_date": saashq.utils.get_datetime(
						saashq.utils.add_to_date(sco.transaction_date, days=10)
					),
				}
			)
