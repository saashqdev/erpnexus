...
def get_supplier_details():
	details = saashq.get_all("Supplier", fields=["name", "supplier_name", "supplier_group"])
	supplier_details = {}
	for d in details:
		supplier_details.setdefault(
			d.name,
			saashq._dict({"supplier_name": d.supplier_name, "supplier_group": d.supplier_group}),
		)
...
def get_purchase_order_details(company_list, filters):
	db_po = saashq.qb.DocType("Purchase Order")
	db_po_item = saashq.qb.DocType("Purchase Order Item")

	query = (
		saashq.qb.from_(db_po)
