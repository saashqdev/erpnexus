...
from erpnexus.buying.doctype.supplier_scorecard_variable.supplier_scorecard_variable import (
...
class TestSupplierScorecardVariable(IntegrationTestCase):
	def test_variable_exist(self):
		for d in test_existing_variables:
			my_doc = saashq.get_doc("Supplier Scorecard Variable", d.get("name"))
