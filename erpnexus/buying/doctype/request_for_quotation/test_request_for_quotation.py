...
from erpnexus.buying.doctype.request_for_quotation.request_for_quotation import (
	RequestforQuotation,
...
from erpnexus.crm.doctype.opportunity.opportunity import make_request_for_quotation as make_rfq
from erpnexus.crm.doctype.opportunity.test_opportunity import make_opportunity
from erpnexus.stock.doctype.item.test_item import make_item
from erpnexus.templates.pages.rfq import check_supplier_has_docname_access
...
class TestRequestforQuotation(IntegrationTestCase):
	...
	def test_make_supplier_quotation_with_special_characters(self):
		saashq.delete_doc_if_exists("Supplier", "_Test Supplier '1", force=1)
	...
	def test_make_supplier_quotation_from_portal(self):
		...
		supplier_quotation_doc = saashq.get_doc("Supplier Quotation", supplier_quotation_name)
	...
	def test_make_multi_uom_supplier_quotation(self):
		...
		supplier_quotation_name = create_supplier_quotation(rfq)
		supplier_quotation = saashq.get_doc("Supplier Quotation", supplier_quotation_name)
	...
	def test_get_pdf(self):
		...
		self.assertEqual(saashq.local.response.type, "pdf")

	def test_portal_user_with_new_supplier(self):
		supplier_doc = saashq.get_doc(
			{
				"doctype": "Supplier",
...
def make_request_for_quotation(**args) -> "RequestforQuotation":
	...
	rfq = saashq.new_doc("Request for Quotation")
