...
saashq.ui.form.on("Supplier Scorecard", {
	setup: function (frm) {
	...
	load_criteria: function (frm) {
		saashq.call({
			method: "erpnexus.buying.doctype.supplier_scorecard_criteria.supplier_scorecard_criteria.get_criteria_list",
			callback: function (r) {
...
saashq.ui.form.on("Supplier Scorecard Scoring Standing", {
	standing_name: function (frm, cdt, cdn) {
		var d = saashq.get_doc(cdt, cdn);
		if (d.standing_name) {
			return frm.call({
				method: "erpnexus.buying.doctype.supplier_scorecard_standing.supplier_scorecard_standing.get_scoring_standing",
				child: d,
				args: {
...
saashq.ui.form.on("Supplier Scorecard Scoring Criteria", {
...
var loadAllStandings = function (frm) {
	saashq.call({
		method: "erpnexus.buying.doctype.supplier_scorecard_standing.supplier_scorecard_standing.get_standings_list",
		callback: function (r) {
