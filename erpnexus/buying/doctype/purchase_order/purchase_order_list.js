saashq.listview_settings["Purchase Order"] = {
	add_fields: [
		"base_grand_total",
		"company",
		"currency",
	...
	onload: function (listview) {
		var method = "erpnexus.buying.doctype.purchase_order.purchase_order.close_or_unclose_purchase_orders";
		...
		listview.page.add_action_item(__("Purchase Invoice"), () => {
			erpnexus.bulk_transaction_processing.create(listview, "Purchase Order", "Purchase Invoice");
		});

		listview.page.add_action_item(__("Purchase Receipt"), () => {
			erpnexus.bulk_transaction_processing.create(listview, "Purchase Order", "Purchase Receipt");
		});

		listview.page.add_action_item(__("Advance Payment"), () => {
			erpnexus.bulk_transaction_processing.create(listview, "Purchase Order", "Payment Entry");
		});
	},
};
