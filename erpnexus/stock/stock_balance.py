...
import saashq
from saashq.utils import cstr, flt, now, nowdate, nowtime

from erpnexus.controllers.stock_controller import create_repost_item_valuation_entry
...
def set_stock_balance_as_per_serial_no(
	...
	for d in bin:
		...
		sle_doc = saashq.get_doc(sle_dict)
