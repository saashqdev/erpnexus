...
class TestStockUtilities(IntegrationTestCase, StockTestMixin):
	def test_barcode_scanning(self):
		...
		batch = saashq.get_doc(doctype="Batch", item=batch_item.name).insert()
		...
		serial = saashq.get_doc(
			doctype="Serial No", item_code=serial_item.name, serial_no=saashq.generate_hash()
		).insert()
