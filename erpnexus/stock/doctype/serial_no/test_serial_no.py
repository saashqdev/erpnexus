...
class TestSerialNo(IntegrationTestCase):
	...
	def test_cannot_create_direct(self):
		saashq.delete_doc_if_exists("Serial No", "_TCSER0001")

		sr = saashq.new_doc("Serial No")
	...
	def test_inter_company_transfer(self):
		...
		serial_no = saashq.get_doc("Serial No", serial_nos[0])
	...
	def test_inter_company_transfer_intermediate_cancellation(self):
		...
		sn_doc = saashq.get_doc("Serial No", serial_nos[0])
		...
		self.assertRaises(saashq.ValidationError, dn.cancel)
		...
		self.assertRaises(saashq.ValidationError, se.cancel)
		self.assertRaises(saashq.ValidationError, dn.cancel)
		self.assertRaises(saashq.ValidationError, pr.cancel)
	...
	def test_auto_fetch(self):
		...
		# expiry date
		saashq.db.set_value("Batch", batch1, "expiry_date", "1980-01-01")
