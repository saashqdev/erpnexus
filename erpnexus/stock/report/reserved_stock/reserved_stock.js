...
saashq.query_reports["Reserved Stock"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
		...
		},
		{
			...
			get_options: function () {
				return saashq.query_report.get_filter_value("voucher_type");
			},
		},
		{
		...
		},
		{
			...
			get_options: function () {
				return saashq.query_report.get_filter_value("from_voucher_type");
			},
		},
		{
