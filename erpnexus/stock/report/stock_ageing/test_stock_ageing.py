...
from erpnexus.stock.report.stock_ageing.stock_ageing import FIFOSlots, format_report_data


class TestStockAgeing(IntegrationTestCase):
	def setUp(self) -> None:
		self.filters = saashq._dict(company="_Test Company", to_date="2021-12-10", ranges=["30", "60", "90"])
