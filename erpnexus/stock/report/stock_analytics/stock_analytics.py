...
from saashq.utils import get_first_day as get_first_day_of_month
from saashq.utils import get_first_day_of_week, get_quarter_start, getdate
...
def get_items(filters):
	...
	if item_code := filters.get("item_code"):
		...
		return saashq.get_all("Item", filters=item_filters, pluck="name", order_by=None)
