...
class TestTimesheet(IntegrationTestCase):
	...
	def test_sales_invoice_from_timesheet(self):
		...
		timesheet = saashq.get_doc("Timesheet", timesheet.name)
	...
	def test_timesheet_billing_based_on_project(self):
		...
		ts = saashq.get_doc("Timesheet", timesheet.name)
	...
	def test_timesheet_time_overlap(self):
		...
		timesheet = saashq.new_doc("Timesheet")
		...
		self.assertRaises(saashq.ValidationError, timesheet.save)
...
def update_activity_type(activity_type):
	activity_type = saashq.get_doc("Activity Type", activity_type)
