...
saashq.query_reports["Timesheet Billing Summary"] = {
	tree: true,
	initial_depth: 0,
	filters: [
		{
		...
		},
		{
			...
			label: __("From Date"),
			fieldtype: "Date",
			default: saashq.datetime.add_months(saashq.datetime.month_start(), -1),
		},
		{
			fieldname: "to_date",
			label: __("To Date"),
			fieldtype: "Date",
			default: saashq.datetime.add_days(saashq.datetime.month_start(), -1),
		},
		{
