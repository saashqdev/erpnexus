...
saashq.ui.form.on("Asset Depreciation Schedule", {
	onload: function (frm) {
...
saashq.ui.form.on("Depreciation Schedule", {
	make_depreciation_entry: function (frm, cdt, cdn) {
		var row = locals[cdt][cdn];
		if (!row.journal_entry) {
			saashq.call({
				method: "erpnexus.assets.doctype.asset.depreciation.make_depreciation_entry",
				args: {
	...
	depreciation_amount: function (frm, cdt, cdn) {
		erpnexus.asset.set_accumulated_depreciation(frm);
	},
});

erpnexus.asset.set_accumulated_depreciation = function (frm) {
