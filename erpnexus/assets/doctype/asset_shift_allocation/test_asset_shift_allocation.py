...
from erpnexus.assets.doctype.asset.test_asset import create_asset
...
class TestAssetShiftAllocation(IntegrationTestCase):
	...
	def test_asset_shift_allocation(self):
		...
		asset_shift_allocation = saashq.get_doc(
		...
		asset_shift_allocation = saashq.get_doc("Asset Shift Allocation", asset_shift_allocation.name)
