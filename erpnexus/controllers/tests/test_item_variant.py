...
from erpnexus.controllers.item_variant import copy_attributes_to_variant, make_variant_item_code
from erpnexus.stock.doctype.item.test_item import set_item_variant_settings
...
def make_item_variant():
	saashq.delete_doc_if_exists("Item", "_Test Variant Item-XSL", force=1)
...
def make_quality_inspection_template():
	...
	if saashq.db.exists("Quality Inspection Template", qc_template):
		return qc_template

	qc = saashq.new_doc("Quality Inspection Template")
