...
class TestTaxes(IntegrationTestCase):
	def setUp(self):
		...
		self.item_group = saashq.get_doc(
			{
				"doctype": "Item Group",
		...
		self.item_tax_template = saashq.get_doc(
			{
			...
			doc = saashq.get_doc(
				{
					...
					"currency": "USD",
					"schedule_date": saashq.utils.nowdate(),
					"delivery_date": saashq.utils.nowdate(),
