erpnexus.landed_cost_taxes_and_charges = {
		...
		saashq.ui.form.on(doctype, {
			...
			set_account_currency: function (frm, cdt, cdn) {
				...
				if (row.expense_account) {
					saashq.db.get_value("Account", row.expense_account, "account_currency", function (value) {
						saashq.model.set_value(cdt, cdn, "account_currency", value.account_currency);
			...
			set_exchange_rate: function (frm, cdt, cdn) {
				...
				if (row.account_currency == company_currency) {
					...
					saashq.call({
						...
						callback: function (r) {
							if (r.message) {
								saashq.model.set_value(cdt, cdn, "exchange_rate", r.message);
							}
						},
					});
				}
