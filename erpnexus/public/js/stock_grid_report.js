...
erpnexus.StockGridReport = class StockGridReport extends saashq.views.TreeGridReport {
	...
	get_serialized_buying_rates() {
		...
		if (saashq.report_dump.data["Serial No"]) {
			$.each(saashq.report_dump.data["Serial No"], function (i, sn) {
