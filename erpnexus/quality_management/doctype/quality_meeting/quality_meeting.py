...
class QualityMeeting(Document):
	...
	if TYPE_CHECKING:
		...
		from erpnexus.quality_management.doctype.quality_meeting_agenda.quality_meeting_agenda import (
			QualityMeetingAgenda,
		)
		from erpnexus.quality_management.doctype.quality_meeting_minutes.quality_meeting_minutes import (
