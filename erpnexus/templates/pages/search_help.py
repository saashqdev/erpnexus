...
from saashq.utils.global_search import search
from jinja2 import utils


def get_context(context):
	context.no_cache = 1
	if saashq.form_dict.q:
		query = str(utils.escape(sanitize_html(saashq.form_dict.q)))
...
def get_help_results_sections(text):
	out = []
	settings = saashq.get_doc("Support Settings", "Support Settings")
