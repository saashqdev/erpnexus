...
def get_context(context):
	...
	setting = saashq.get_doc("Support Settings")
...
def get_favorite_articles(favorite_articles):
	...
	for article in favorite_articles:
		description = saashq.utils.strip_html(article.content)
...
def get_help_article_list():
	help_article_list = []
	category_list = saashq.get_all("Help Category", fields="name")
	for category in category_list:
		help_articles = saashq.get_all(
			"Help Article",
			fields="*",
