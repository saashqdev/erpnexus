...
from erpnexus.selling.doctype.customer.customer import get_credit_limit, get_customer_outstanding
...
def execute(filters=None):
	...
	customer_naming_type = saashq.db.get_single_value("Selling Settings", "cust_master_name")
...
def get_details(filters):
	...
	return saashq.db.sql(sql_query, filters, as_dict=1)
