...
from erpnexus.selling.report.sales_person_target_variance_based_on_item_group.sales_person_target_variance_based_on_item_group import (
	execute,
)
...
def create_target_distribution(fiscal_year):
	distribution = saashq.new_doc("Monthly Distribution")
...
def create_sales_target_doc(
	...
	sales_target_doc = saashq.new_doc(sales_field_dt)
