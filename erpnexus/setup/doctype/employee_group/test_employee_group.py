...
def make_employee_group():
	...
	employee_group_exist = saashq.db.exists("Employee Group", "_Test Employee Group")
...
def get_employee_group():
	employee_group = saashq.db.exists("Employee Group", "_Test Employee Group")
