saashq.treeview_settings["Company"] = {
	ignore_fields: ["parent_company"],
	get_tree_nodes: "erpnexus.setup.doctype.company.company.get_children",
	add_tree_node: "erpnexus.setup.doctype.company.company.add_node",
	filters: [
		{
			fieldname: "company",
			fieldtype: "Link",
