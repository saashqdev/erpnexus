...
def setup(company=None, patch=True):
	...
	if saashq.db.count("Company", {"country": "United States"}) <= 1:
...
def add_print_formats():
	saashq.reload_doc("regional", "print_format", "irs_1099_form")
	saashq.db.set_value("Print Format", "IRS 1099 Form", "disabled", 0)
